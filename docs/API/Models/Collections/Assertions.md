...
[View source code](https://github.com/franciscokloganb/openfga-php/blob/main/src/Models/Collections/Assertions.php)
...
- `Countable`
- `ArrayAccess`
- [`AssertionsInterface`](AssertionsInterface.md)

## Related Classes

- [AssertionsInterface](../Models/Collections/AssertionsInterface.md) (interface)
