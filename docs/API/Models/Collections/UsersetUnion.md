...
[View source code](https://github.com/franciscokloganb/openfga-php/blob/main/src/Models/Collections/UsersetUnion.php)
...
- `Countable`
- `ArrayAccess`
- [`UsersetUnionInterface`](UsersetUnionInterface.md)

## Related Classes

- [UsersetUnionInterface](../Models/Collections/UsersetUnionInterface.md) (interface)
...
[View source](https://github.com/franciscokloganb/openfga-php/blob/main/src/Models/Collections/UsersetUnion.php#L30)
